...
\resumeSubHeadingListStart
  ...
  \resumeSubheading{Embedded Systems Engineer : Triton Robosub}{Nov 2021 -- Present}
    ...
    \resumeSubheading{Research Assistant : Bioinspired Robotics and Design Lab}{Aug 2022 -- Sept 2022}
    {\underline{}}{\vspace{-15pt}}
    \resumeItemListStart
  ...
  {\underline{}}{\vspace{-15pt}}
    \resumeItemListStart
      umeItem{Assisted course instructor in teaching students ways to build an autoboat with a buoy, how to monitor, generate and analyze collected sensor data, and use data visualization and analysis tools to present findings.}
    \resumeItemListEnd
\resumeSubHeadingListEnd
